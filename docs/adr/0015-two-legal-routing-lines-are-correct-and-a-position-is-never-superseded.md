...
**Addressee corrected by [ADR 0016](0016-a-phase-number-forward-references-a-map-that-does-not-exist.md).** The heading "Handed to Phase 2 as a checkpoint, not a finding" and "a checkpoint Phase 2 inherits, not a mandate" are false as addressed — [#119](https://github.com/98kb/skills/issues/119) records this checkpoint as not reachable at seed either. Read both as *handed forward* to whichever map first holds two same-class positions; the falsifiable condition is unaffected.
